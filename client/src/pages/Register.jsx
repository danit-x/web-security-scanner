        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2 text-center border-b border-[#8f706b]/20 pb-6">
            ...
            <p className="text-xs uppercase tracking-[0.2em] text-[#8f706b] font-bold">
              Create a new account to start scanning websites.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <label className="block relative group" htmlFor="register-name">
            ...
            <label className="block relative group" htmlFor="register-email">
              <span className="absolute -top-2.5 left-3 bg-[#050000] px-2 text-[10px] uppercase tracking-widest font-bold text-[#8f706b] z-10 border border-[#8f706b]/20 border-b-0">
                Email Address
              </span>
              <Input
            ...
            <label className="block relative group" htmlFor="register-password">
              <span className="absolute -top-2.5 left-3 bg-[#050000] px-2 text-[10px] uppercase tracking-widest font-bold text-[#8f706b] z-10 border border-[#8f706b]/20 border-b-0">
                Passphrase
              </span>
              <Input
            ...
            <label className="block relative group" htmlFor="register-confirm-password">
              <span className="absolute -top-2.5 left-3 bg-[#050000] px-2 text-[10px] uppercase tracking-widest font-bold text-[#8f706b] z-10 border border-[#8f706b]/20 border-b-0">
                Confirm Passphrase
              </span>
              <Input
